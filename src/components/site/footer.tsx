    ...
    <footer className="relative mt-24 overflow-hidden bg-secondary text-secondary-foreground">
      ...
      <div className="relative container-x py-20">
        <div className="grid gap-12 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-6 text-sm text-white/70 max-w-xs">
              Veteran-owned electrical contractor serving residential, commercial and industrial
              clients across South Florida — 24 hours a day.
            </p>
            <div className="mt-6 flex gap-3">
              <a href={site.phoneHref} className="btn-primary text-sm">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li className="flex gap-3">
                ...
                <a href={site.phoneHref} className="text-white hover:text-primary font-semibold">
                  {site.phone}
                </a>
              </li>
              <li className="flex gap-3">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-white/50">
          <div>
            © {new Date().getFullYear()} {site.name}. Licensed Florida Electrical Contractor. All
            rights reserved.
          </div>
