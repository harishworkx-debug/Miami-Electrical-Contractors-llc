...
import {
  Phone, MessageCircle, ShieldCheck, Star, Zap, Clock, Award, CheckCircle2,
  Home as HomeIcon, Building2, Factory, ArrowRight, Sparkles, MapPin,
  AlertTriangle, Wrench, Lightbulb, Plug,
} from "lucide-react";
...
const HERO_IMG = "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=1800&q=80";
...
const projects = [
  { title: "Luxury Estate Rewire", tag: "Coral Gables", img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=900&q=80" },
  { title: "Brickell High-Rise Retrofit", tag: "Brickell", img: "https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=900&q=80" },
  { title: "Restaurant Panel Upgrade", tag: "Miami Beach", img: "https://images.unsplash.com/photo-1514933651103-005eec06c04b?auto=format&fit=crop&w=900&q=80" },
  { title: "Warehouse Switchgear", tag: "North Miami", img: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=900&q=80" },
  { title: "Boutique Lighting Design", tag: "Design District", img: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?auto=format&fit=crop&w=900&q=80" },
  { title: "Office Tenant Build-Out", tag: "Downtown Miami", img: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=80" },
];

const safetyTips = [
  { icon: AlertTriangle, title: "Never ignore a warm outlet", body: "Warm switch plates or discolored outlets are the #1 predictor of an electrical fire. Call an electrician immediately." },
  { icon: Wrench, title: "Replace old panels", body: "Federal Pacific and Zinsco panels are known fire hazards. Upgrade to a modern 200A service." },
  { icon: Lightbulb, title: "Use LED, not overloaded fixtures", body: "Never exceed the wattage rating of a light fixture — LED equivalents run cool and safe." },
  { icon: Plug, title: "GFCI everywhere near water", body: "Kitchens, baths, outdoor and pool areas require GFCI protection to prevent shock." },
];
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[92vh] flex items-center bg-secondary text-secondary-foreground overflow-hidden">
        ...
        <div
          ...
          style={{ background: "radial-gradient(closest-side, oklch(0.77 0.17 68 / 0.7), transparent)" }}
        />
        <div
          className="absolute -top-40 -left-20 h-[28rem] w-[28rem] rounded-full opacity-30 blur-3xl"
          style={{ background: "radial-gradient(closest-side, oklch(0.7 0.14 230 / 0.6), transparent)" }}
        />
        ...
        <div className="relative container-x grid gap-14 lg:grid-cols-[1.2fr_1fr] items-center py-24">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-lg text-white/75 leading-relaxed">
              {site.tagline.split("·")[0]} delivering residential, commercial and industrial electrical solutions across South Florida — 24 hours a day, 7 days a week.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link to="/contact" className="btn-ghost text-base bg-white/10 border-white/15 text-white hover:bg-white/15">
            ...
            <div className="glass-dark rounded-3xl p-6 md:p-8 shadow-elegant">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="mt-1 font-display text-2xl font-semibold">Talk to an electrician</div>
                </div>
              ...
              <div className="mt-5 flex flex-col gap-3">
                <a href={site.phoneHref} className="flex items-center justify-between rounded-2xl bg-primary text-primary-foreground px-4 py-3 font-semibold">
                  <span className="inline-flex items-center gap-2"><Phone className="h-4 w-4"/> Call {site.phone}</span>
              ...
              <div className="mt-6 grid grid-cols-3 gap-3 text-center">
                ...
                <div className="rounded-xl bg-white/5 p-3">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-white/60">Response</div>
                </div>
                <div className="rounded-xl bg-white/5 p-3">
      ...
      <section className="container-x py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] items-start">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Why choose us</div>
            ...
            <p className="mt-5 text-muted-foreground max-w-lg">
              We're a veteran-owned electrical contractor built for the way South Florida actually operates — fast, permitted, safe, and always on call.
            </p>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                { icon: ShieldCheck, title: "Veteran-Owned Discipline", body: "Trained, uniformed and background-checked crews." },
                { icon: Clock, title: "24/7 Live Dispatch", body: "A real person answers every call, day or night." },
                { icon: Award, title: "Licensed & Insured", body: "Florida-licensed contractor with full liability coverage." },
                { icon: Sparkles, title: "Premium Workmanship", body: "Every install is done to code and to look great." },
              ].map(({ icon: Icon, title, body }) => (
                <div key={title} className="rounded-2xl border border-border p-5 hover:border-primary/40 hover:shadow-elegant transition">
            ...
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="relative">
                  <div className={`font-display text-4xl md:text-5xl font-semibold ${i % 3 === 0 ? "text-primary" : "text-secondary"}`}>{s.value}</div>
                  <div className={`mt-2 text-sm ${i % 3 === 0 ? "text-white/70" : "text-muted-foreground"}`}>{s.label}</div>
                </div>
              </motion.div>
            ))}
          </div>
            ...
            {categories.map(({ icon: Icon, title, desc, items, img, slug }, i) => (
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  <img src={img} alt={`${title} electrical services in Miami`} loading="lazy" className="h-full w-full object-cover transition duration-700 group-hover:scale-110" />
      ...
      <section className="container-x py-24">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Featured work</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Featured electrical projects.</h2>
          </div>
          <p className="max-w-md text-muted-foreground">A selection of recent installs, rewires and upgrades across Miami-Dade.</p>
        </div>
      ...
      <section className="bg-secondary text-secondary-foreground py-24 relative overflow-hidden">
        ...
        <div className="relative container-x">
          <div className="max-w-2xl">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">How we work</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight">A calm, professional process — from first call to final walkthrough.</h2>
          </div>
          <div className="mt-14 grid gap-6 md:grid-cols-4">
            {[
              { step: "01", title: "Call or Message", body: "A real electrician answers 24/7 and schedules your visit." },
              { step: "02", title: "Free Estimate", body: "We diagnose on-site and quote a fixed, upfront price." },
              { step: "03", title: "Licensed Install", body: "Uniformed technicians deliver code-compliant work." },
              { step: "04", title: "Warranty & Walkthrough", body: "We test, tour and back every install with warranty." },
            ].map((s, i) => (
              <motion.div
                key={s.step}
                initial={{ opacity: 0, y: 20 }}
        ...
        <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-background to-accent/10 p-10 md:p-14">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] items-center">
            <div>
              ...
              <h3 className="mt-4 font-display text-3xl md:text-4xl font-semibold text-secondary">Power out? Sparking outlet? We're on the way.</h3>
              <p className="mt-3 text-muted-foreground max-w-xl">Live dispatcher around the clock — 60-minute response almost anywhere in Miami-Dade County.</p>
            </div>
      ...
      <section className="bg-surface py-24">
        <div className="container-x">
          <div className="max-w-2xl">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Safety</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Electrical safety tips from Miami's pros.</h2>
          </div>
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {safetyTips.map(({ icon: Icon, title, body }) => (
              <div key={title} className="rounded-3xl bg-card border border-border p-7 hover:shadow-elegant transition">
      ...
      <section className="container-x py-24">
        <div className="grid gap-10 lg:grid-cols-[1fr_2fr] items-start">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Reviews</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Loved by South Florida.</h2>
            <div className="mt-6 rounded-3xl bg-secondary text-white p-6">
              <div className="flex items-center gap-2">
                <Stars/>
                <span className="text-lg font-semibold">5.0</span>
              </div>
              <div className="mt-1 text-sm text-white/70">Based on 180+ verified Google reviews</div>
              <Link to="/reviews" className="mt-5 inline-flex btn-primary text-sm">Read all reviews</Link>
            </div>
          </div>
      ...
      <section className="bg-surface py-24">
        <div className="container-x grid gap-12 lg:grid-cols-[1fr_1.4fr]">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Common questions from our Miami customers.</h2>
            <p className="mt-5 text-muted-foreground">Don't see your question? Call {site.phone} — a licensed electrician answers 24/7.</p>
          </div>
      ...
      <section className="container-x py-24">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Service areas</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Where we work.</h2>
          </div>
        </div>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {locations.map((l) => (
            ...
            >
              <img src={l.image} alt={`Electrician in ${l.city}, FL`} loading="lazy" className="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-secondary via-secondary/40 to-transparent" />
              <div className="absolute inset-x-0 bottom-0 p-6 text-white">
                ...
                <div className="mt-2 font-display text-2xl font-semibold">Electrician in {l.city}</div>
      ...
      <section className="container-x py-24">
        <div className="grid gap-8 lg:grid-cols-[1fr_1.4fr] items-start">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Visit us</div>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-secondary">Based on Biscayne Blvd — serving all of South Florida.</h2>
            <div className="mt-6 space-y-3 text-secondary/80">
              <div className="flex items-start gap-3"><MapPin className="h-5 w-5 text-primary mt-0.5"/> <span>{site.street}<br/>{site.city}, {site.state} {site.zip}</span></div>
              <div className="flex items-start gap-3"><Clock className="h-5 w-5 text-primary mt-0.5"/> <span>{site.hours}</span></div>
              <div className="flex items-start gap-3"><Phone className="h-5 w-5 text-primary mt-0.5"/> <a href={site.phoneHref} className="font-semibold hover:text-primary">{site.phone}</a></div>
            </div>
          </div>
