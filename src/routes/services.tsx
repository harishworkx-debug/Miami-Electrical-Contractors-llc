...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional residential, commercial and industrial electrical services including wiring, lighting, panel upgrades, troubleshooting and emergency repairs in Miami, Florida." },
      { property: "og:title", content: "Electrical Services in Miami, FL" },
      { property: "og:description", content: "Residential, commercial and industrial electrical services across Miami and South Florida — 24/7." },
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            ...
            >
              ...
              <div className="p-7">
                <h2 className="font-display text-xl font-semibold text-secondary group-hover:text-primary transition">{s.title}</h2>
