export const site = {
  ...
  url: "https://www.miamielectricalcontracting.com",
  phone: "(305) 679-6434",
...
const PROCESS_DEFAULT = [
  {
    title: "Free Estimate",
    body: "We diagnose on-site and quote a fixed, written price before any work begins.",
  },
  {
    title: "Scheduled Service",
    body: "A licensed Miami electrician arrives on time with the parts and tools needed.",
  },
  {
    title: "Code-Compliant Work",
    body: "Every install meets NEC and City of Miami permitting standards.",
  },
  {
    title: "Final Walkthrough",
    body: "We test every circuit, clean up, and back the job with a written warranty.",
  },
];
...
export const services: Service[] = [
  {
    ...
    process: [
      ...
      {
        title: "Make Safe",
        body: "First priority is de-energizing any active life-safety hazard.",
      },
      {
        title: "Diagnose & Fix",
        body: "We locate the fault and repair on the spot whenever possible.",
      },
      {
        title: "Restore & Report",
        body: "Full written report of the fault, the fix and any follow-up work.",
      },
    ],
    ...
    faqs: [
      {
        ...
        a: "Yes — 365 nights a year a licensed electrician is on call anywhere in Miami-Dade.",
      },
      {
        q: "How fast can you arrive?",
        a: "60 minutes or less in most of Miami-Dade. Ocean-side and outer suburbs may add 10–20 minutes.",
      },
      {
        q: "Do you charge extra at night?",
        a: "We charge a transparent after-hours dispatch fee, quoted before any work begins — never a surprise.",
      },
    ],
    related: [
  ...
  },
  {
    ...
    short:
      "Fast, code-compliant electrical repair for outlets, switches, wiring, breakers and lighting across Miami.",
    ...
    faqs: [
      {
        q: "Do you charge to diagnose an issue?",
        a: "We charge a flat, upfront diagnostic fee that is credited toward the repair once approved.",
      },
      {
        q: "Can you finish repairs same day?",
        a: "Most residential electrical repairs are completed on the first visit.",
      },
    ],
    related: [
  ...
  },
  {
    ...
    short:
      "Professional electrical installation for outlets, fixtures, appliances, panels and full remodels in Miami.",
    ...
    faqs: [
      {
        ...
        a: "Yes — as long as they are UL-listed. We can also source premium fixtures for you.",
      },
      {
        q: "Will you patch the drywall?",
        a: "We minimize wall openings and offer optional patch, texture and paint restoration.",
      },
    ],
    related: [
      "outlet-repair-miami-fl",
      "switch-installation-miami-fl",
      "ceiling-fan-installation-miami-fl",
    ],
  ...
  },
  {
    ...
    short:
      "Upgrade to 200 A, 320 A or 400 A service — safely power EVs, AC and modern appliances across Miami.",
    ...
    faqs: [
      {
        ...
        a: "Yes — every service change requires a permit and inspection. We handle both for you.",
      },
      { q: "How long will power be off?", a: "Typically 4–8 hours on the day of the upgrade." },
    ],
    related: [
      "electrical-wiring-miami-fl",
      "ev-charger-installation-miami-fl",
      "surge-protection-miami-fl",
    ],
  ...
  },
  {
    ...
    short:
      "New and replacement electrical wiring for Miami homes, additions, remodels and commercial spaces.",
    ...
    faqs: [
      {
        q: "Can you wire without opening every wall?",
        a: "In most cases yes — we fish new runs through walls and ceilings with minimal disruption.",
      },
      {
        q: "Do you handle low-voltage too?",
        a: "Yes — networking, coax and smart-home low-voltage is available alongside line-voltage work.",
      },
    ],
  ...
  },
  {
    ...
    short:
      "Recessed, architectural and smart lighting installation designed for Miami homes and businesses.",
    ...
    faqs: [
      {
        ...
        a: "Yes — we install and program Lutron Caseta, RA3, Control4 and other smart lighting systems.",
      },
      {
        q: "Do you patch ceilings after install?",
        a: "Yes — we offer optional patch and paint restoration.",
      },
    ],
    related: [
  ...
  },
  {
    ...
    short:
      "Landscape, security and architectural outdoor lighting engineered for South Florida weather.",
    ...
    faqs: [
      {
        q: "Is landscape lighting built for South Florida weather?",
        a: "Yes — we use marine-grade brass, bronze and stainless fixtures rated for coastal salt exposure.",
      },
      {
        q: "Can I control outdoor lighting from my phone?",
        a: "Yes. Smart transformers with app control are standard on our premium installs.",
      },
    ],
    related: [
  ...
  },
  {
    ...
    short:
      "Turn-key commercial electrical for retail, offices, restaurants and multi-tenant Miami buildings.",
    ...
    process: [
      {
        ...
        body: "We meet with owners and GCs to scope the electrical package end-to-end.",
      },
      {
        title: "Permit & Plans",
        body: "We handle City of Miami permits, sealed drawings and utility coordination.",
      },
      {
        title: "Install & Commission",
        body: "Certified journeymen deliver clean installs on aggressive commercial timelines.",
      },
      {
        title: "Handoff & Support",
        body: "Documentation, warranty and optional preventive maintenance.",
      },
    ],
    whyChooseUs: WHY_US_DEFAULT,
    faqs: [
      {
        ...
        a: "Yes — nights and weekends are standard for our commercial clients.",
      },
      {
        q: "Can you pull commercial permits?",
        a: "As a licensed Florida electrical contractor we handle every permit ourselves.",
      },
    ],
    related: [
      "panel-upgrade-miami-fl",
  ...
  },
  {
    ...
    short:
      "Whole-home electrical service for Miami homeowners — from a single outlet to a full home rewire.",
    ...
    faqs: [
      {
        q: "Do you offer 24-hour residential service?",
        a: "Yes — we dispatch a licensed electrician anywhere in Miami-Dade 24/7 for emergencies.",
      },
      {
        q: "Can you handle full home rewires?",
        a: "Absolutely — we specialize in older Miami homes, condo remodels and new-construction rewiring.",
      },
    ],
    related: [
      "electrical-wiring-miami-fl",
  ...
  },
  {
    ...
    short:
      "Level-2 EV charger installation for homes, condos and workplaces across Miami — Tesla, ChargePoint and universal.",
    ...
    faqs: [
      {
        ...
        a: "Not always. We run a load calculation first — many homes support a Level-2 charger with a load-managed install.",
      },
      {
        q: "Do you install commercial EV chargers?",
        a: "Yes — from single-unit multifamily to multi-charger workplace deployments.",
      },
    ],
    related: [
      "panel-upgrade-miami-fl",
    ...
    faqs: [
      {
        ...
        a: "We run a load calculation on your home or business to right-size a standby generator — whole-home or essential circuits only.",
      },
      {
        q: "Do you handle the gas connection?",
        a: "We coordinate with a licensed gas plumber and handle every electrical portion end-to-end.",
      },
    ],
    related: [
      "panel-upgrade-miami-fl",
  ...
  },
  {
    ...
    short:
      "Whole-home and business surge protection to shield electronics from Miami's frequent lightning strikes.",
    ...
    faqs: [
      {
        q: "Is one whole-home surge device enough?",
        a: "It handles the majority of surges. We recommend layered protection — panel SPD plus point-of-use outlets on sensitive electronics.",
      },
      {
        q: "Will it protect against a direct lightning strike?",
        a: "No SPD can absorb a direct strike; it dramatically reduces the more common induced and utility-side surges that damage Miami electronics.",
      },
    ],
    related: [
      "panel-upgrade-miami-fl",
      "generator-installation-miami-fl",
      "electrical-inspection-miami-fl",
    ],
  ...
  },
  {
    ...
    short:
      "Ceiling fan installation, replacement and rebalancing for Miami homes and outdoor patios.",
    ...
    faqs: [
      {
        q: "Can you install a fan where there is no fixture today?",
        a: "Yes — we can fish new wiring, install a fan-rated box and add a wall control.",
      },
      {
        q: "Can you install my customer-supplied fan?",
        a: "Absolutely — as long as it is UL-listed we will install it and haul away the old one.",
      },
    ],
    related: [
      "lighting-installation-miami-fl",
  ...
  },
  {
    ...
    short:
      "Diagnose and repair tripping, buzzing or failed circuit breakers across Miami homes and businesses.",
    ...
    faqs: [
      {
        q: "Should I just replace a tripping breaker?",
        a: "Not without diagnosing first — a tripping breaker is often protecting you from a downstream fault. We test the circuit before swapping hardware.",
      },
      {
        q: "Do you stock breakers on the truck?",
        a: "Yes — the most common Square D, Siemens, Eaton and GE breakers are on the van.",
      },
    ],
    related: [
      "panel-upgrade-miami-fl",
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Why did one outlet stop working?",
        a: "Usually a tripped GFCI upstream, a loose wire in a backstab connection, or a shared-neutral fault. We trace and repair the exact cause.",
      },
      {
        q: "Can you add outlets without opening walls?",
        a: "In most cases yes — we fish new outlet runs with minimal or no drywall damage.",
      },
    ],
    related: [
      "switch-installation-miami-fl",
  ...
  },
  {
    ...
    short:
      "Light switch installation and replacement — smart, dimmer, three-way and motion switches across Miami.",
    ...
    faqs: [
      {
        q: "Can you install smart switches without a neutral wire?",
        a: "Yes — we install no-neutral smart switch options like Lutron Caseta when a neutral is unavailable.",
      },
      {
        q: "Why does my LED flicker with a dimmer?",
        a: "Usually an incompatible dimmer. We install LED+ dimmers matched to your specific bulbs.",
      },
    ],
    related: [
      "lighting-installation-miami-fl",
  ...
  },
  {
    ...
    short:
      "Pre-purchase, insurance and safety electrical inspections for Miami homes and commercial buildings.",
    ...
    faqs: [
      {
        q: "Do you provide four-point insurance inspections?",
        a: "Yes — Florida insurers accept our four-point inspection reports.",
      },
      {
        q: "How long does an inspection take?",
        a: "60–90 minutes for a typical single-family home; longer for commercial.",
      },
    ],
    related: [
      "code-correction-miami-fl",
      "panel-upgrade-miami-fl",
      "commercial-electrician-miami-fl",
    ],
  ...
  },
  {
    ...
    title: "Home Rewiring",
    short:
      "Complete home rewiring for older Miami properties — safe, code-compliant, and phased to keep power on.",
    ...
    faqs: [
      {
        ...
        a: "Most single-family Miami homes are rewired in 3–7 working days depending on size and access.",
      },
      {
        q: "Will you patch the drywall?",
        a: "Yes — we minimize wall openings and offer full patch, texture and paint restoration.",
      },
    ],
    related: [
      "electrical-wiring-miami-fl",
  ...
  },
  {
    ...
    short:
      "Correct failed electrical inspections and bring older Miami properties up to current NEC and city code.",
    ...
    faqs: [
      {
        q: "Can you fix everything on a failed inspection report?",
        a: "Yes — we handle every item on a typical four-point or municipal inspection failure.",
      },
      {
        q: "Do you handle the re-inspection?",
        a: "Yes — we schedule and meet the inspector so you do not have to.",
      },
    ],
...
export const locations: Location[] = [
  {
    ...
    faqs: [
      {
        q: "Do you cover all of Miami 24/7?",
        a: "Yes — we dispatch anywhere in the City of Miami around the clock.",
      },
      {
        q: "Are you licensed in Florida?",
        a: "Yes — fully licensed Florida electrical contractor and insured.",
      },
      {
        q: "Do you serve condos with association requirements?",
        a: "Yes — we regularly deliver COIs and comply with condo association rules across Miami.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you work on historic Coral Gables homes?",
        a: "Yes — we specialize in careful rewires and upgrades in Mediterranean Revival and other historic properties.",
      },
      {
        q: "Can you coordinate with our architect or designer?",
        a: "Yes — we regularly work alongside Coral Gables architects and interior designers.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you work on both homes and businesses in South Miami?",
        a: "Yes — from single-family homes to retail and medical office electrical.",
      },
      {
        q: "Do you handle historic-district requirements?",
        a: "Yes — permitting and careful workmanship in historic zones is a core specialty.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you service hotels and restaurants?",
        a: "Yes — hospitality is a core practice, with overnight scheduling to protect guest experience.",
      },
      {
        q: "Can you provide COIs for buildings?",
        a: "Yes — we deliver COIs the same day for any Miami Beach building on request.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you serve industrial and warehouse clients in Hialeah?",
        a: "Yes — 3-phase power, service changes and motor controls are a core specialty.",
      },
      {
        q: "Do you have Spanish-speaking electricians?",
        a: "Yes — bilingual crews are standard on Hialeah service calls.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you install EV chargers in Kendall garages?",
        a: "Yes — Level-2 EV charger installation is one of our most-requested Kendall services.",
      },
      {
        q: "Can you handle HOA and community requirements?",
        a: "Yes — HOA coordination and community-standard installs are part of every quote.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you handle office and warehouse build-outs in Doral?",
        a: "Yes — tenant improvements and commercial build-outs are a core practice.",
      },
      {
        q: "Can you work off-hours to avoid business disruption?",
        a: "Yes — nights and weekends are common for our Doral commercial clients.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you cover Homestead 24/7 for emergencies?",
        a: "Yes — emergency response is available around the clock across South Miami-Dade.",
      },
      {
        q: "Do you work on agricultural and rural properties?",
        a: "Yes — well pumps, barn wiring and irrigation electrical are part of what we do.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you install whole-home generators in Pinecrest?",
        a: "Yes — Generac and Kohler standby generators are a common Pinecrest install.",
      },
      {
        q: "Will you protect our landscaping during work?",
        a: "Yes — landscape protection and post-work restoration are standard on Pinecrest jobs.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: "Do you serve industrial clients in North Miami?",
        a: "Yes — warehouse and light-industrial work is a core specialty.",
      },
      {
        q: "Do you offer maintenance contracts?",
        a: "Yes — recurring preventive-maintenance contracts are available for North Miami businesses.",
      },
    ],
  },
];
...
export type PageMatch =
  { type: "service"; service: Service } | { type: "location"; location: Location };
...
export const generalFaqs = [
  ...
  },
  {
    ...
    a: "Miami, Miami Beach, Coral Gables, South Miami, Hialeah, Kendall, Doral, Homestead, Pinecrest, North Miami and the greater South Florida area.",
  },
  {
